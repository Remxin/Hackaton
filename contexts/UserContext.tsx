...
export default function UserContextProvider({ children }: ProviderProps) {
    ...
    return (
        <UserContext.Provider value={{ user: userData, loading, errors, dispatch: {
            login
        } }}>
            {children}
...
export function useUserContext() {
    ...
    if (typeof(contextVals) === null || !contextVals?.dispatch) throw new Error("This custom hook can be used only inside provider children")
